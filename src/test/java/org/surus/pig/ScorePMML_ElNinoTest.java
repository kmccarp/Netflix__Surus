...
public class ScorePMML_ElNinoTest {
    ...
    private Tuple buildElNinoOutputEvent( String buoyDayID, String buoy, String day, String latitude, String longitude, String zonWinds, String merWinds, String humidity, String airtemp, String sSTemp, double airtempPredicted) {
